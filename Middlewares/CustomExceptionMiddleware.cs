...
namespace WebApi.Middlewares
{
	public class CustomExceptionMiddleware
	{
		...
		{
			var watch = Stopwatch.StartNew(); // response başlama zamanı 
			try
			{
			...
			{
				watch.Stop(); //Eğer yukarıda await_next sırasında bir hata alırsa sürenin doğru hesaplanabilmesi için
							  //stop exception catch bloğu içerisine alınır.
